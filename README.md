The complete NE-Graph-BERT code and the SpaceGraph dataset will be available soon!
=
...
- Download and run locally
  ...
  Of course you can also download it locally and run it with a local HTTP server. Start the HTTP server in the project's root directory:
